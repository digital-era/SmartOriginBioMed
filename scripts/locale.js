        ...
        const translations = {
            "zh-CN": {
                ...
                "manifestoPara3": "扁鹊、希波克拉底、张仲景、约翰·多诺霍……他们的卓越并非偶然，而是源于对生命本质的深刻体悟：中医的整体观、西医的实证精神、多组学的系统洞察，以及脑机接口的无限可能。他们理解人体系统，面对病痛挑战，每一次的发现与突破都如同生命长河中一位位深邃的智者，以其独特的洞察，指引着方向，最终塑造了医学的进程。",
                ...
                "manifestoConclusion": "我们的使命是以AI原生智慧，汇聚生命长河的智者之声，解决人间疾苦。",
